            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <h4 style ="margin-left:5px">Hi <?php echo  'Admin' ?></h4>
        ...
        <div class="page-wrapper">
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header ">
								<h4 class="card-title d-inline-block">Upcoming Appointments</h4> <a href="appointment.php" class="btn btn-primary float-right">View all</a>
							</div>
							...
							<table class="table table-border table-striped custom-table datatable mb-0">
                               ...
                               *  from appointment join adminpage on adminpage.id=appointment.Adminname ");
            ...
            ?>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel shadow">
            ...
            ?>
						...
						<div class="card">
							<div class="card-header ">
								<h4 class="card-title d-inline-block">New Patient</h4> <a href="adminpatienttable.php" class="btn btn-primary float-right">View all</a>
							</div>
							<div class="card-body p-0">
								<div class="table-responsive">
                                       ...
                                       <td><?php echo $row ['Username']?></td>
                                        ...
                                        <td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item"  href="adduserupdate.php?id='<?php echo $row['id']?>'">
