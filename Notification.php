            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li >
                            <a href="department.php"><i class="fa fa-dashboard"></i> <span>Departments</span></a>
                        </li>
						<li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="Addnotification.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add New Notification</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                               ...
                               echo 'Available Notication  is ' .  mysqli_num_rows($result);
                               if(mysqli_num_rows($result)>0){
                                   ...
                                   <tr>
                                       ...
                                       <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> </td>
                                        ...
                                        <td><?php echo $row ['messagefrom']?></td>
                                        ...
                                        <td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item"  href ="admin_del_note.php?id='<?php echo $row ['id']?>'" data-toggle="modal" data-target="">
