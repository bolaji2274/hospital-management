...
<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    if(strlen($Age) <= 4){
     ...
     }else{$result = mysqli_query($conn, "Insert into appointment ( Age, Adminname, Department, AppointmentDate, AppointmentTime, messages, patient_id) value 
        ( '$Age', '$Adminname', '$Department',  '$AppointmentDate','$AppointmentTime', '$messages', '$id')");
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="user_add_app.php" method ="POST">
                            <div class="row">
                                ...
                                if((mysqli_num_rows($query)>0)){
                                    $options = (mysqli_fetch_all($query,MYSQLI_ASSOC));
                                        ...
                                        <select class="select" name ="Adminname">
                                            ...
                                            <?php foreach($options as $option){
                                                ?>
											<option value="<?php echo $option ['id']?>" ><?php echo $option ['Adminname']?></option>
                                            <?php
                                            }
                                            ?>
