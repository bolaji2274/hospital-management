<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    if(mysqli_num_rows($check_email) > 0){
        ...
        $result = mysqli_query($conn, "Insert into adminpage (Adminname, Fullname, Email, Password, Address, Age, phone, department ) value 
        ('$Adminname',' $Fullname', '$Email', '$Password', '$Address',  '$Age','$Phone','$Department')");

        if ($result == True){
            echo '<script>alert("New Doctor Added Successful")</script>';
            echo '<script>window.location.href= "doctor_re.php"</script>';
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="doctor_re.php" method = "post" >
                            <div class="row">
                                <div class="col-sm-6">
								...
								<div class="col-sm-6">
									<div class="row">
										<div class="col-sm-12">
										 <div class="form-group">
                       <?php $query = mysqli_query ($conn, "select * from department");
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name ="submit">Create Doctor</button>
                            </div>
                        </form>
                    </div>
                </div>
