...
if(isset($_POST['submit'])){
    ...
    $checkEmail =mysqli_query($conn, "select * from userpage ");
    if (strlen($Address)<3){
        echo '<script> alert("Address must greater than three character")</script>';
    }else{
       
    $result = mysqli_query($conn, "Update userpage set Fullname = '$Fullname', Email = '$Email', Password = '$Password',
    Address = '$Address' where id = $id ");
    if($result){
        echo '<script>window.alert("Record Updated Succesfully")</script>';
        echo '<script>window.location.href="adminpatienttable.php"</script>';
...
<?php  $result = mysqli_query ($conn, "Select * from userpage ");
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo $row ['Username']?>"  name ="Fullname">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
