<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    $check_email = mysqli_query($conn, "Select * from userpage where Email = '$Email'");
    $check_password = mysqli_query($conn, "Select * from userpage where Password = '$Password'");
    ...
    if(mysqli_num_rows($check_email) > 0){
        ...
        $result = mysqli_query($conn, "Insert into userpage (Username, Fullname, Email, Password, Address, Age ) value 
        ('$Username', '$Fullname', '$Email', '$Password', '$Address',  '$Age')");

        if ($result == True){
            echo '<script>alert("New Patient Added ")</script>';
            echo '<script>window.location.href= "doctor_add_pati.php"</script>';
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="doctor_add_pati.php" method = "post" >
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name ="submit">Create Patient</button>
                            </div>
                        </form>
                    </div>
                </div>
