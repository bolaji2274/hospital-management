...
<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    $check_department = mysqli_query($conn, "Select * from department where Department = '$department'");
    ...
    if(strlen($department) <= 1){
        ...
        $result = mysqli_query($conn, "Insert into department ( Department, Description) value 
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="add_department.php" method = "post">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn " name ="submit">Create Department</button>
                            </div>
                        </form>
                    </div>
                </div>
