            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">View Leaves</h4>
                    </div>
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table mb-0">
                               ...
                               $count = 1;
                               $result = mysqli_query ($conn, "select * from leavetable");
                               echo 'Available Leave  is ' .  mysqli_num_rows($result);
                               if(mysqli_num_rows($result)>0){
                                   ...
                                   <tr>
                                       ...
                                       <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> </td>
                                        ...
                                        <td><?php echo $row ['fromday']?>-<?php echo $row ['today']?></td>
