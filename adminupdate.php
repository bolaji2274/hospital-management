...
if(isset($_POST['submit'])){
    ...
    $checkEmail =mysqli_query($conn, "select * from adminpage ");
    ...
    $result = mysqli_query($conn, "Update adminpage set Fullname = '$Fullname', Email = '$Email', Password = '$Password',
    Address = '$Address', department  =  ' $Department'  where id = $id ");
    if($result){
        echo '<script>window.alert("Record Updated Succesfully")</script>';
        echo '<script>window.location.href="Doctor_dash.php"</script>';
        ...
        echo '<script>alert("Erorr Updating Record")</script>';
        ...
        <div class="header">
            ...
            <div class="dropdown mobile-user-menu float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" hhref="adminprofile.php">My Profile</a>
                    <a class="dropdown-item" href="adminupdate.php?id=<?php echo $row['id']?>">Edit Profile</a>
                    <a class="dropdown-item" href="dashboard.php">Dashboard</a>
                    <a class="dropdown-item" href="logout.php">Logout</a>
                </div>
...
<?php  $result = mysqli_query ($conn, "Select * from adminpage ");
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo $row['Adminname']?>"  name ="Fullname">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo $row['Password']?>" name ="Password">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
