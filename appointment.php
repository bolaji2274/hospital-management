            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="Addnotification.php"><i class="fa fa-calendar"></i> <span>Noticeboard</span></a>
                        </li>
                        <li>
						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
                                ...
                                *  from appointment join adminpage on adminpage.id=appointment.Adminname ");
                                echo 'Appointment is ' .  mysqli_num_rows($result);
                                        ...
                                        <td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item"  href="admin_del_app.php?id='<?php echo $row['id']?>'"  data-toggle="modal" data-target="">
