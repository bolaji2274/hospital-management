            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="user_add_app.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Appointment</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
									...
									<tr>
                                       ...
                                       <td class="text-right">
											<div class="dropdown dropdown-action">
                                                ...
                                                <a class="dropdown-item"  href="user_del_app.php?id='<?php echo $row['id']?>'"  data-toggle="modal" data-target="">
