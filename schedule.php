					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table mb-0">
                               ...
                               echo 'Available Schedule  is ' .  mysqli_num_rows($result);
                               if(mysqli_num_rows($result)>0){
                                   ...
                                   <tr>
                                       ...
                                       <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> </td>
                                        ...
                                        <td><?php echo $row ['available']?>-<?php echo $row ['availableend']?>
                                        ...
                                        <td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item"  href ="schedule_del.php?id='<?php echo $row ['id']?>'" data-toggle="modal" data-target="">
