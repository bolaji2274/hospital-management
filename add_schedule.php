...
if(isset($_POST['submit'])){
    ...
    $check_department = mysqli_query($conn, "Select * from schedule where department = '$doctorname'");
...
if(strlen($doctorname) <= 1){
    ...
    $result = mysqli_query($conn, "Insert into schedule ( doctorname, department, starttime, endtime, available, availableend) value 
    ( '$doctorname', '$department', '$starttime', '$endtime', '$available','$availableend')");

    if ($result == True){
        echo '<script>alert(" Schedule Created Successful")</script>';
                    ...
                    <div class="col-lg-8 offset-lg-2">
                       ...
                       $query = mysqli_query ($conn, "select * from department");
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										<label>Available Day From</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
										<label>Available Day To</label>
										<select class="select" name ="availableend">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name ="submit">Create Schedule</button>
                            </div>
                        </form>
                    </div>
                </div>
