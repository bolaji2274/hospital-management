...
if(isset($_POST['submit'])){
    ...
    $check_department = mysqli_query($conn, "Select * from department ");
    ...
    $result = mysqli_query($conn, "Update department SET Department =   '$department', Description = '$description' WHERE id = $id ");
    if($result){
        echo '<script>window.alert("Department Updated Succesfully")</script>';
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="admin_update_dep.php" method = "POST">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn " name ="submit">Update Department</button>
                            </div>
                        </form>
                    </div>
                </div>
