...
$result = mysqli_query ($conn, "Select * from adminpage where Adminname = '$Adminame' or Email = '$Adminame'");
...
<body>
    <div class="main-wrapper">
        <div class="header">
            ...
            <a id="mobile_btn" class="mobile_btn float-left" href="#sidebar"></a>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="doctor_re.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Doctors</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
									...
									<tr>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item"  href="addocupdate.php?id='<?php echo $row['id']?>'"><i class="fa fa-pencil m-r-5"></i> Edit</a>
