...
<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    $check_department = mysqli_query($conn, "Select * from notificationboard where notification = '$notification'");
    
   
    if(strlen($notification) <= 1){
        echo '<script>'. "alert('Invalid Notification')".'</script>';
    
   

  
    }else{
        $result = mysqli_query($conn, "Insert into notificationboard ( notification, messagefrom) value 
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="Doctor_add_not.php" method = "post">
                        <div class="form-group">
                                <label>Type Notification</label>
                                <textarea cols="30" rows="4" class="form-control" name = "notification"></textarea>
                            </div>
							<div class="form-group">
								<label>Message By </label>
								<input class="form-control" type="text" name ="messagefrom">
							</div>
