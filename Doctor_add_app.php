<?php
 ...
 if (isset ($_POST['submit'])){
    ...
    $check_doctor = mysqli_query($conn, "Select * from appointment where AppointmentTime = '$AppointmentTime'");
    ...
    }elseif(mysqli_num_rows($check_doctor)>0){
        echo '<script>'. "alert('Doctor has Been Booked By This Time ')".'</script>';
     }else{$result = mysqli_query($conn, "Insert into appointment ( Age, Adminname, Department, AppointmentDate, AppointmentTime, messages) value 
        ( '$Age', '$Adminname', '$Department',  '$AppointmentDate','$AppointmentTime', '$messages')");
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="Doctor_add_app.php" method ="POST">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                       <?php $query = mysqli_query ($conn, "select * from adminpage");
                                if((mysqli_num_rows($query)>0)){
                                    $options = (mysqli_fetch_all($query,MYSQLI_ASSOC));
                                        ...
                                        ?> 
                                        <label>Doctor</label>
                                        <select class="select" name ="Adminname">
											<option>Select</option>
                                            <?php foreach($options as $option){
                                                ?>
											<option><?php echo $option ['Adminname']?></option>
                                            <?php
                                            }
                                            ?>
                       ...
                       $query = mysqli_query ($conn, "select * from adminpage where Adminname ='$Adminname' && department ='$department'");
                                if((mysqli_num_rows($query)>0)){
                                    $options = (mysqli_fetch_all($query,MYSQLI_ASSOC));
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="AppointmentDate">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
