...
if(isset($_POST['submit'])){
    ...
    $check_department = mysqli_query($conn, "Select * from leavetable where doctorname = '$doctorname'");
    
   
if(strlen($doctorname) <= 1){
    ...
    $result = mysqli_query($conn, "Insert into leavetable ( doctorname, department, leavetype, fromday, today, day, reason) value 
    ( '$doctorname', '$department', '$leavetype', '$fromday', '$today','$day', '$reason')");

    if ($result == True){
        echo '<script>alert(" leave Requested Successful")</script>';
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action ="doctor_add_leave.php" method ="post">
                        <div class="row">
                        <div class="col-md-6">
                       ...
                       $query = mysqli_query ($conn, "select * from department");
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
										<label>Leave Day From</label>
										<select class="select" name ="fromday">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
										<label>leave Day To</label>
										<select class="select" name ="today">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name ="submit">Create Leave</button>
                            </div>
                        </form>
                    </div>
                </div>
